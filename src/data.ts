...
export const heroes: Hero[] = [
  ...
  },
  {
    ...
    abilities: [
      ...
      },
      {
        name: 'Kitsune Rush',
        description:
          'Summon a fox spirit that rushes forward, accelerating the movement, attack speed, and cooldown of allies that follow in its path.',
      },
    ],
  },
  {
    ...
    abilities: [
      {
        ...
        description:
          'Short-range spray weapon that slows enemies. Can also fire long-range icicles.',
      },
      {
        name: 'Cryo-Freeze',
  ...
  },
  {
    ...
    abilities: [
      ...
      },
      {
        name: 'Annihilation',
        description:
          'Enter Nemesis Form and create an energy swarm surrounding yourself. This swarm will lash out towards nearby enemies, dealing damage and pausing the duration when the damage is dealt.',
      },
    ],
  },
  {
    ...
    abilities: [
      {
        name: 'Railrun',
        description:
          'Rapid firing projectiles that generate energy on hit. Hit impact shot that consumes stored energy.',
      },
      {
        name: 'Power Slide',
  ...
  },
  {
    ...
    abilities: [
      ...
      },
      {
        name: 'Translocator',
        description:
          'Throw a beacon, then press E again to teleport it. Press ABILITY 2 to remove it.',
      },
      {
        name: 'EMP',
        description:
          "Deals damage equals to 40% of all nearby enemies' health, hacking them and destroying barriers around you.",
      },
      {
        name: 'Opportunist',
        description:
          'You detect critically injured enemies through walls, and deal 40% more damage to hacked enemies.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    abilities: [
      ...
      },
      {
        name: 'Grappling Claw',
        description:
          'Lauch a grappling claw to rapidly swing around the area. Enables high-speed collisions to damage and knockback enemies.',
      },
      {
        name: 'Roll',
      ...
      },
      {
        ...
        description:
          'Create temporary personal extra health. Amount increases with more enemies nearby.',
      },
      {
        name: 'Minefield',
  ...
  },
  {
    ...
    role: 'Tank',
    origin:
      'Krasnoyarsk Front (formerly), Novoanskoye Forward Base, Siberia, Russia (formerly), Watchpoint: Gibraltar',
