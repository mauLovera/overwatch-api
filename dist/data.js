export const heroes = [
    ...
    },
    {
        ...
        abilities: [
            {
                name: 'The Viper',
                description: 'Semi-automatic rifle. When zoomed in, damage and accuracy are increased at the cost of rate of fire speed.',
            },
            {
                name: 'Coach Gun',
            ...
            {
                name: 'Dynamite',
                description: 'Throw an explosive that detonates after a short delay or immediately when shot.',
            },
            {
                name: 'B.O.B.',
                description: 'Deploy Bob. He charges forward and knocks enemies into the air, then attacks with his arm cannons.',
            },
        ],
    },
    {
        ...
        abilities: [
            ...
            },
            {
                ...
                description: 'Active to heal yourself and nearby allies instantly, with additional healing over time. Instant heal is doubled for targets less than half health.',
            },
            {
            ...
            },
            {
                ...
                description: 'Project a matrix that doubles the damage and healing effect of allied projectiles.',
            },
            {
                name: 'Exo Boots',
    ...
    },
    {
        ...
        abilities: [
            ...
            },
            {
                ...
                description: 'Fire a bomb that bounces off walls and explodes when it impacts enemies or the ground.',
            },
            {
                name: 'Reconfigure',
    ...
    },
    {
        ...
        abilities: [
            ...
            {
                name: 'Deadeye',
                description: 'Face off against your enemies. Lock on to your enemies and shoot them by retriggering ability.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        abilities: [
            ...
            {
                name: 'Rocket Punch',
                description: 'Hold to charge then release to launch forward and knock an enemy back. Damage increases if the enemy hits a wall.',
            },
            {
                name: 'Seismic Slam',
            ...
            {
                name: 'Power Block',
                description: 'Protect yourself from frontal attacks. Blocking heavy damage empowers Rocket Punch.',
            },
            {
                name: 'Meteor Strike',
                description: 'Leap up into the air. Move the targeting circle, then strike the targeted area.',
            },
        ],
    },
    {
        ...
        abilities: [
            ...
            {
                name: 'Focusing Beam',
                description: 'Channel a beam for a few seconds. Deals very high damage to targets under health.',
            },
            {
                name: 'Duplicate',
                description: 'Become a copy of the targeted enemy hero. They cannot swap heroes for the duration.',
            },
            {
                name: 'Glide',
    ...
    },
    {
        name: 'Genji',
        role: 'Damage',
        origin: 'Hanamura, Japan (formerly), Shambali Monastery, Nepal (formerly), Watchpoint: Gibraltar',
        ...
        abilities: [
            ...
            {
                name: 'Deflect',
                description: 'Deflect incoming projectiles back towards the direction you are aiming and block melee attacks.',
            },
            {
                name: 'Swift Strike',
    ...
    },
    {
        ...
        abilities: [
            ...
            {
                name: 'Jagged Blade',
                description: 'Active: Throw the blade. Re-activate to pull it back, along with any impaled enemy. Passive: Wound enemies hit by Quick Melee or Throw, dealing damage over time.',
            },
            {
                name: 'Scattergun',
                description: 'Pump action shotgun.',
